...
<div id="content_area">
  ...
  <div id="shopping_cart">
    <span style="float:right; font-size:15px; padding:5px; line-height: 40px;">
      ...
      Total Items:<?php total_items();?> Total Price: <?php total_price(); ?> <a href="home.php"> Return to Shopping </a>
...
<div id="products_box">
 ...
 <form action="" method="post" enctype="multipart/form-data">
    ...
    <table aligh="center" width="700" bgcolor="#E87326">
     <tr align="center">
        <td colspan="5"> <h2> Your Product(s) to be checked out</h2></td>
     </tr>
       <tr> <th> Remove: </th>
            <th> Product(s): </th>
            <th> Quantity: </th>
